...
# "Metadata file '${self->repository->metadata->filename}' seems to be corrupted. It should #be a SQLite database -> aborting",
            7 =>
              "An error occurred while initializing metadata file -> aborting",
...
Source only support local directory or ftp:// at this time",
            9 =>
              "Could not read metadata version from metadata file -> aborting",
...
my $filelist = $filesource->get_detailed_file_list;
